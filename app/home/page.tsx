  ...
  return (
    <div className="flex flex-col min-h-[calc(100vh-70px)]">
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-y-2 lg:gap-3 lg:flex-1">
        ...
        <div
          className={`space-y-4 pt-4 lg:pb-4 ${
            isLoading || announcements.length > 0
              ? 'lg:col-span-3 lg:border-r-[1.5px] lg:border-(--color-border-light) lg:pr-3'
              : 'lg:col-span-4'
          }`}
        >
          {/* Continue Watching */}
          {(isLoading || hasContinueWatching) && (
            <motion.div
              className="space-y-2"
          ...
          {(isLoading || myLearning.length > 0) && (
            ...
            >
              ...
              <div className="flex items-stretch overflow-x-auto pb-2 lg:pb-0 gap-3 scrollbar-hide">
                {isLoading ? (
                  <>
                    <CourseCardSkeleton />
                    <CourseCardSkeleton />
                ...
                <motion.div
                  ...
                  className="min-w-35 shrink-0 flex items-center justify-center ml-auto"
                >
                  <Link
                    href="/learning"
